...
- A copy of the NWM v1.2 retrospective data can be browsed [here](https://console.cloud.google.com/storage/browser/national-water-model-reanalysis).
...
Microsoft hosts the NWM input and output datasets in Azure Blob Storage. The dataset is not yet avalible through Microsoft Planetary Computer API. All data files are in NetCDF4 format. Documentation details and file name syntax can be found [here](https://planetarycomputer.microsoft.com/dataset/storage/noaa-nwm).
...
Tom Augspurger of Microsoft has a series of notebooks providing examples of how to use this data from his workshop at the first CIROH Developers Conference. View them [here](https://github.com/TomAugspurger/noaa-nwm). 
