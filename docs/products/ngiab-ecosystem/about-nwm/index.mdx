...
Future versions of the NWM are planned to use the NextGen Framework for its modularity and versatility. To encourage research and contributions to this effort, the NGIAB ecosystem was created as a highly accessible suite of modeling software from which research-grade models can be proposed for and transitioned to operational NWM use.
