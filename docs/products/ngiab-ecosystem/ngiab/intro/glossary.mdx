...
The NGIAB ecosystem offers the [NGIAB Calibration](/docs/products/ngiab-ecosystem/ngiab/components/ngiab-calibration) utility to streamline this process.

### Evaluation
The process of assessing the quality and performance of a hydrologic model.

The NGIAB ecosystem offers [integration](/docs/products/ngiab-ecosystem/ngiab/components/ngiab-teehr) with the [TEEHR](#teehr) toolkit to streamline this process.
...
Both GUI and command-line utilities for subsetting the NextGen reference fabric are available within the [Data Preprocess](/docs/products/ngiab-ecosystem/ngiab/components/ngiab-preprocessor/) utility.
...
### TEEHR
Short for "Tools for Exploratory Evolution in Hydrologic Research", TEEHR is a Python library that provides comprehensive tooling for model [evaluation](#evaluation). TEEHR is [included as a part of the NGIAB ecosystem](/docs/products/ngiab-ecosystem/ngiab/components/ngiab-teehr).

Information on TEEHR is available [here](https://rtiinternational.github.io/teehr/).

### Tethys Platform
Tethys is a Python-based platform for building geospatial web apps. It forms the core of NGIAB's [Data Visualizer](/docs/products/ngiab-ecosystem/ngiab/components/ngiab-visualizer), alongside many other CIROH applications.
