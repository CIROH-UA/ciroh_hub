...
<Tabs>
  <TabItem value="features" label="Key Features" default>
    <table>
      ...
      <tbody>
        <tr>
        <th><Link to="/docs/products/ngiab-ecosystem/ngiab/components/ngiab-preprocessor/">Data Preprocess</Link></th>
        <td>
        ...
        <tr>
          <th>
            ...
            <p style={{'margin':'0'}}>(<Link to="/docs/products/ngiab-ecosystem/ngiab/distributions/ngiab-docker/">Cloud</Link>, <Link to="/docs/products/ngiab-ecosystem/ngiab/distributions/ngiab-singularity/">HPC</Link>)</p>
          </th>
          <td>
        ...
        <tr>
          <th><Link to="/docs/products/ngiab-ecosystem/ngiab/components/ngiab-teehr/">TEEHR Evaluation</Link></th>
          <td>
        ...
        <tr>
          <th><Link to="/docs/products/ngiab-ecosystem/ngiab/components/ngiab-visualizer/">Data Visualizer</Link></th>
          <td>
        ...
        <tr>
          <th><Link to="/docs/products/ngiab-ecosystem/nrds/">DataStreamCLI</Link></th>
          <td>
            - Complete workflow for scalable and reproducible NextGen simulations using NGIAB
            - Serves as the on-server workflow for NextGen Research DataStream executions
            - Integrated and built-in tooling for forcing processing, subsetting, BMI config file generation and more
          </td>
          <td>
            - ngen-cal
            - t-route
        ...
        <tr>
          <th><Link to="/docs/products/ngiab-ecosystem/nrds/forcingprocessor/">Forcing Processor</Link></th>
          <td>
            - General tool for scalable and efficient processing of NWM gridded data into NextGen compatible catchment-averaged data
            - Works for forcings and channel routing data
            - Deployed as a modular datastream in the NextGen Research DataStream to provide timely NextGen forcings data
          </td>
          <td> </td>
        </tr>
        <tr>
          <th><Link to="/docs/products/ngiab-ecosystem/ngiab/components/ngiab-calibration/">NGIAB-Cal</Link></th>
          <td>
    ...
    <table>
      <thead>
        <tr>
          ...
          <th>
            <p style={{'margin':'0'}}>NGIAB Implementation</p>
            <p style={{'margin':'0'}}>(<Link to="/docs/products/ngiab-ecosystem/ngiab/distributions/ngiab-docker/">Cloud</Link>, <Link to="/docs/products/ngiab-ecosystem/ngiab/distributions/ngiab-docker/">HPC</Link>)</p>
          </th>
          <th><Link to="/docs/products/ngiab-ecosystem/ngiab/components/ngiab-teehr/">TEEHR Evaluation</Link></th>
          <th><Link to="/docs/products/ngiab-ecosystem/ngiab/components/ngiab-visualizer/">Data Visualizer</Link></th>
          <th><Link to="/docs/products/ngiab-ecosystem/nrds/">DataStreamCLI</Link></th>
