...
Running NextGen requires building a standard run directory complete with only the necessary files. This is done automatically with the [Data Preprocess](/docs/products/ngiab-ecosystem/ngiab/components/ngiab-preprocessor) tool. Below is an explanation of the standard run directory.
