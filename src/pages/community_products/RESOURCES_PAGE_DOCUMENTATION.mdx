...
### 2. `/src/components/HydroShare/ResourceBrowser/index.js`
...
### 4. `/src/components/HydroShare/ResourceBrowser/ResourceList/index.js`
...
### 5. `/src/components/HydroShare/ResourceBrowser/ResourceList/ResourceRow.js`
...
#### `/src/components/HydroShare/ResourceBrowser/styles.module.css`
```css
.wrapper {
	width: 100%;
	padding: 3rem 0;
...
#### `/src/components/HydroShare/ResourceBrowser/ResourceList/styles.module.css`
```css
.listContainer {
  display: flex;
