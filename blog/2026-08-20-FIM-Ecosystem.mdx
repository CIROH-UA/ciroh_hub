---
title: "CIROH Flood Inundation Mapping (FIM) Community Ecosystem: A Large-Scale Operational Flood Modeling-to-Evaluation Framework"
description: "A large-scale, cloud-native, open-source ecosystem for flood inundation modeling, simulation, benchmarking, and evaluation, built at the University of Alabama's Surface Dynamics Modeling Lab with support from CIROH."
slug: fim-community-ecosystem
tags: [Flooding, "Flood Inundation Mapping", "Operational Research", "Large-Scale", Hydrology, HAND, "National Water Model", Benchmarking, Evaluation, "Remote Sensing", "Hydrodynamic Modeling"]
authors: [supath-dhital, dipsikha-devi, anupal-baruah, dinuke-munasinghe, parvaneh-nikrou, dan-tian, yixian-chen, sagy-cohen]
image: /img/blog/2026-08-fim-ecosystem/ecosystem-overview.png
---

import Link from "@docusaurus/Link"
import ProfileCards from '/src/components/Blog/ProfileCards';

export const fimProfiles = [
  {
    name: 'Supath Dhital',
    title: 'Geography Researcher II',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Supath_Dhital.jpg',
  },
  {
    name: 'Dipsikha Devi',
    title: 'Postdoctoral Researcher',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Dipsikha_Devi.jpg',
  },
  {
    name: 'Anupal Baruah',
    title: 'Research Scientist',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Anupal_Baruah.jpg',
  },
  {
    name: 'Dinuke Munasinghe',
    title: 'Research Scientist',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Dinuke_Munasinghe.jpg',
  },
  {
    name: 'Parvaneh Nikrou',
    title: 'PhD Candidate',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Parvaneh_Nikrou.jpg',
  },
  {
    name: 'Dan Tian',
    title: 'Postdoctoral Researcher',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Dan_Tian.jpg',
  },
  {
    name: 'Yixian Chen',
    title: 'Research Scientist',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Yixian_Chen.jpg',
  },
  {
    name: 'Sagy Cohen (PI)',
    title: 'Professor',
    organization: 'The University of Alabama',
    imagePath: '/img/profiles/Sagy_Cohen.jpg',
  },
]
...
<figure style={{ textAlign: "center" }}>
  <img
   class="dark-mode-white-bg"
   src={require('@site/static/img/blog/2026-08-fim-ecosystem/fimbox-workflow.jpg').default}
   width='100%'
   alt="The FIMbox modular workflow: shared inputs feed swappable stages, from model initialization and preprocessing to FIM generation and evaluation."
   />
  <figcaption><em>The FIMbox modular workflow: shared inputs feed swappable stages, from model initialization and preprocessing to FIM generation and evaluation, so terrain-based (e.g., HAND) or hydrodynamic models can be configured, run, and compared in one framework, with FIMsim, FIMeval, and FIMbench plugged in for simulation, evaluation, and benchmarks.</em></figcaption>
</figure>
...
<figure style={{ textAlign: "center" }}>
  <img
   class="dark-mode-white-bg"
   src={require('@site/static/img/blog/2026-08-fim-ecosystem/technical-architecture.jpg').default}
   width='100%'
   ...
   />
  <figcaption><em>Technical architecture components of the ecosystem: FIMserv assembles HAND-based flood maps from cloud-hosted terrain and streamflow data sources; FIMeval retrieves benchmarks and evaluation layers from cloud-hosted endpoints; and FIMbench disseminates its curated database via the web portal and the Python API, drawing from a single AWS S3 source of truth.</em></figcaption>
</figure>
...
Each framework is provided with step-by-step documentation and example notebooks on its GitHub repository: [FIMserv](https://github.com/sdmlua/FIMserv/tree/main/docs), [FIMeval](https://github.com/sdmlua/fimeval/tree/main/docs), [FIMbench](https://github.com/sdmlua/fimbench/docs), [FIMbox](https://github.com/sdmlua/fimbox#module-documentation) and so on, so any user can go from installation to a first flood map and its evaluation without leaving the documentation. Run them wherever you work, from a laptop to Google Colab or CIROH's 2i2c JupyterHub. Prefer a point-and-click route? The [FIMbench web portal](https://tethys.ciroh.org/apps/fimbench-gui/) lets you browse the benchmark database, and FIMsim runs today as a desktop application.
...
**CIROH cyberinfrastructure used:** [CIROH AWS S3 cloud storage](https://ciroh-owp-hand-fim.ciroh.org/index.html) hosts the OWP-precalculated HUC8 HAND hydrofabric datasets streamed on demand by FIMserv, and hosts the [FIMbench benchmark database](https://sdmlab.ciroh.org/#FIM_Database/); the CIROH Tethys Platform / CIROH Portal hosts the [FIMbench WebApp](https://tethys.ciroh.org/apps/fimbench-gui/), developed with our partners at Aquaveo (we are also thinking of hosting a curated virtual environment/image on 2i2c services soon). This cyberinfrastructure is the backbone that makes the ecosystem scalable and interoperable: because every component reads from and writes to the same CIROH cloud-hosted data, one tool's output is directly consumable by the next, and users never need to download oversized national datasets. CIROH's Tethys hosting and 2i2c JupyterHub lower the barrier further, providing point-and-click and zero-install routes into the tools, while CIROH compute resources make evaluation across hundreds of events and continental-scale runs practical rather than prohibitive.

### Additional Links

- Understand the CIROH FIM ecosystem visually: https://sdml.ua.edu/fim-ecosystem/
- Explore the CIROH FIM ecosystem more interactively with our [NotebookLM Mind Map](https://notebooklm.google.com/notebook/0cbf3ebc-9ebd-41c9-ba56-24922c934be7/artifact/66c95aa6-5532-4a64-b3db-3dde7c000b70?utm_source=nlm_web_share&utm_medium=google_oo&utm_campaign=art_share_1&utm_content=&utm_smc=nlm_web_share_google_oo_art_share_1_)
...
<ProfileCards profiles={fimProfiles} />
