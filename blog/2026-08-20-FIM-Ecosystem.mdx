...
<figure style={{ textAlign: "center" }}>
  <img
   ...
   src={useBaseUrl('/img/blog/2026-08-fim-ecosystem/ecosystem-overview.png')}
   width='100%'
...
<figure style={{ textAlign: "center" }}>
  <img
   class="dark-mode-white-bg"
   src={useBaseUrl('/img/blog/2026-08-fim-ecosystem/fimbench-webapp.png')}
   width='100%'
   alt="Homepage snapshot of the extensive Flood Inundation Mapping Benchmark data web portal."
   />
  <figcaption><em>Homepage snapshot of the extensive Flood Inundation Mapping Benchmark data web portal (Web portal: <a href="https://tethys.ciroh.org/apps/fimbench-gui/">https://tethys.ciroh.org/apps/fimbench-gui/</a>)</em></figcaption>
</figure>
...
<figure style={{ textAlign: "center" }}>
  <img
   class="dark-mode-white-bg"
   src={useBaseUrl('/img/blog/2026-08-fim-ecosystem/fimbox-workflow.jpg')}
   width='100%'
...
<figure style={{ textAlign: "center" }}>
  <img
   class="dark-mode-white-bg"
   src={useBaseUrl('/img/blog/2026-08-fim-ecosystem/technical-architecture.jpg')}
   width='100%'
